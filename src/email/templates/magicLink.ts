      ...
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;max-width:560px;width:100%;">
        <tr>
          <td style="padding:32px 32px 16px;border-bottom:4px solid #0d1b3d;">
            ...
            <h1 style="margin:6px 0 0;font-size:24px;color:#0d1b3d;font-weight:800;letter-spacing:-0.01em;">Parent Express</h1>
          </td>
        </tr>
        <tr>
          <td style="padding:28px 32px 8px;">
            ...
            <p style="margin:0 0 24px;">
              <a href="${url}" style="display:inline-block;background:#0d1b3d;color:#ffffff;text-decoration:none;padding:12px 24px;border-radius:8px;font-weight:600;font-size:15px;">Sign in to Parent Express</a>
            </p>
        ...
        <tr>
          <td style="padding:20px 32px 28px;border-top:1px solid #d8dde7;">
            <p style="margin:0;font-size:12px;color:#4a5876;">Parent Express · © Wicko Waypoint · <a href="https://wickowaypoint.com" style="color:#1a2a5e;">wickowaypoint.com</a></p>
          </td>
        </tr>
      </table>
    </td>
